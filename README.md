...
## 🛠️ Tech Stack
- ☁️ **Cloud:** AWS (Lambda, DynamoDB, API Gateway, S3, CloudFront, SNS, SQS, SES)
- 🐍 **Languages:** Python
- 🛡️ **DevOps & Tools:** GitHub Actions, CI/CD, Serverless Framework
- 🎓 **Certifications:** PMP®, CSM®, ITIL®, Microsoft & Cisco

---

## 📊 Featured Project
### [AWS Serverless Marketplace](https://github.com/taofeekadeyemi/aws-serverless-marketplace)
A production-ready, event-driven serverless order processing system built on AWS.
* ✔ 100% uptime, 73+ transactions processed
* 🔗 [**View Live Demo**](https://d3r7plath9y10q.cloudfront.net/)
